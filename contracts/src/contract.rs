...
impl VirtualTokenContract {
    ...
    /// Returns the rolling commitment aggregate for a round, if initialized.
    pub fn get_rolling_commitment(
        env: Env,
        round_id: u64,
    ) -> Option<RollingCommitment> {
        crate::commitments::_get_rolling_commitment(&env, round_id)
    }
