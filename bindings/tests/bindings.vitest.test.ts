...
const EXPECTED_CONTRACT_METHODS = [
  ...
  'get_oracle_min_confidence_bps',
  'get_oracle_strict_mode',
  'update_oracle_heartbeat',
  'get_oracle_heartbeat',
  'is_oracle_live',
  'set_oracle_stale_threshold',
  'get_oracle_stale_threshold',
  'get_protocol_health',
  'get_protocol_status',
  'get_round_status',
  ...
  'get_precision_predictions_page',
  'get_updown_positions_page',
  'balance'
] as const;
