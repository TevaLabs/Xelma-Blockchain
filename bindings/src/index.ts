...
export const ContractError = {
  ...
  4: { message: "InvalidBetAmount" },
  5: { message: "NoActiveRound" },
  6: { message: "RoundEnded" },
  7: { message: "InsufficientBalance" },
  8: { message: "AlreadyBet" },
  9: { message: "Overflow" },
  10: { message: "InvalidPrice" },
  11: { message: "InvalidDuration" },
  12: { message: "InvalidMode" },
  13: { message: "WrongModeForPrediction" },
  14: { message: "RoundNotEnded" },
  15: { message: "StaleOracleData" },
  16: { message: "InvalidOracleRound" },
  17: { message: "RoundAlreadyActive" },
  18: { message: "ContractPaused" },
  19: { message: "WindowOutOfRange" },
  20: { message: "FutureOracleData" },
  21: { message: "PayoutOverflow" },
  22: { message: "RoundNotCancellable" },
  23: { message: "StakeExceedsMax" },
  24: { message: "ExposureCapExceeded" },
  25: { message: "PendingWinningsCapExceeded" },
  26: { message: "InvalidStartPrice" },
  27: { message: "OracleNonceReused" },
  28: { message: "InvalidMinParticipants" },
  29: { message: "InvalidPrecisionCap" },
  30: { message: "PrecisionCapExceeded" },
  31: { message: "OracleDeviationExceeded" },
  32: { message: "UnsupportedSchemaVersion" },
  33: { message: "MigrationActiveRound" },
  34: { message: "CommitmentNotFound" },
  35: { message: "AlreadyRevealed" },
  36: { message: "InvalidRevealWindow" },
  37: { message: "HashMismatch" },
  38: { message: "OracleNetworkMismatch" },
  39: { message: "InvalidProtocolFeeBps" },
  40: { message: "MintLimitExceeded" },
  41: { message: "NoPendingRotation" },
  42: { message: "RotationDelayNotElapsed" },
  43: { message: "InvalidArchiveRetention" },
  44: { message: "InvalidCommitment" },
  45: { message: "InvalidSalt" },
  46: { message: "NoRoundTemplate" },
  47: { message: "OracleTimestampOutsideWindow" },
  48: { message: "PendingWinningsNotExpired" },
  49: { message: "EpochBudgetExceeded" },
  50: { message: "OracleNotLive" },
  51: { message: "InvalidPayoutPolicy" },
  52: { message: "BelowMinBet" },
  53: { message: "InsufficientOracleQuorum" },
  54: { message: "TooFewObservations" },
  55: { message: "OracleOutlierRejected" },
  56: { message: "DuplicateOracleSource" },
  57: { message: "InvalidObservationOrder" },
  58: { message: "UnsupportedDataKeyForTtlTouch" },
  59: { message: "PendingWinningsNotFound" },
  60: { message: "ExpiryNotConfigured" },
  61: { message: "AccessDenied" },
  62: { message: "ProposalNotFound" },
  63: { message: "ProposalExpired" },
  64: { message: "GovInvalidState" },
  65: { message: "GovUnauthorized" },
  66: { message: "IllegalPhaseTransition" },
  67: { message: "OracleHeartbeatUnhealthy" },
  68: { message: "ClaimBatchTooLarge" },
  69: { message: "DuplicateClaimAddress" },
  70: { message: "EarlyCashoutDisabled" },
  71: { message: "PositionNotFound" },
  72: { message: "InvalidPhaseForCashout" },
  73: { message: "WrongModeForCashout" },
  74: { message: "InsuranceInvalidSplit" },
  75: { message: "InsuranceInsufficientFund" },
  76: { message: "InvalidAmount" },
  77: { message: "DisputeWindowExpired" },
  78: { message: "ClaimLocked" },
  79: { message: "RoundStartLedgerReused" },
  80: { message: "PageSizeExceeded" }
},
  /**
